...
void	init_triangle(t_data *data, char *line)
{
	...
	ft_node_addback(&(data->objects), init_object_node(triangle, data));
	temp = ft_lastnode(data->objects);
	split_line(data, &line);
	temp->triang.pt_a = ft_convert_coords(data);
	freen(&data->str);
	split_line(data, &line);
	temp->triang.pt_b = ft_convert_coords(data);
	freen(&data->str);
	split_line(data, &line);
	temp->triang.pt_c = ft_convert_coords(data);
	freen(&data->str);
	split_line(data, &line);
	temp->triang.rgb = ft_convert_rgb(data);
	freen(&data->str);
}
